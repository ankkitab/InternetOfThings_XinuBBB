...
extern devcall gpputc(struct dentry *devptr, char val);
extern devcall gpgetc(struct dentry *devptr);
extern devcall gpinit(struct dentry *devptr);

devcall anlread(struct dentry *devptr,char* buf,int32 count);
